...
public class GiaoVienController implements Initializable {
    ...
    public void setCellValueFactory(){
        colMaGiaoVien.setCellValueFactory(new PropertyValueFactory<GiaoVien, Integer>("maGiaoVien"));
        colTen.setCellValueFactory(new PropertyValueFactory<GiaoVien, String>("tenGiaoVien"));
