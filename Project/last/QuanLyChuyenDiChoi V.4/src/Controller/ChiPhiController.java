...
public class ChiPhiController implements Initializable {
    ...
    public void initdata(String MaChuyenDi) {
        lbMaChuyenDi.setText(MaChuyenDi);
    ...
    private boolean checkNull() {
        if (tfVeCong.getText().isEmpty() | tfLinhTinh.getText().isEmpty() | tfNuocUong.getText().isEmpty() | tfPhiHDV.getText().isEmpty() | tfTienAnTrua.getText().isEmpty() | tfTienAnXe.getText().isEmpty() | tfTienXe.getText().isEmpty()) {
            return false;
        } else {
            return true;
        }
